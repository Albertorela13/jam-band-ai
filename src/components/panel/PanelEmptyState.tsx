  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center justify-center gap-6 rounded-2xl border border-border bg-card px-8 py-16 text-center shadow-warm">
      ...
      <div className="space-y-2">
        <h2 className="font-display text-3xl font-semibold tracking-tight">Your stage is empty.</h2>
        <p className="text-base text-muted-foreground">Add your first bandmate to start jamming.</p>
      </div>
      <Button
        size="lg"
